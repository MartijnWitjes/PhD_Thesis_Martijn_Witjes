...
\section{Materials and Methods}
    ...
    \begin{figure}
    \centering
    \includegraphics[width=\linewidth]{fig1_methodology.pdf}
    ...
    \subsection{Training and reference data}
        ...
        \begin{figure}
        \centering
        \includegraphics[width=0.9\linewidth]{fig2_points.pdf}
    ...
    \begin{figure}[H]
        ...
        \includegraphics[width=0.9\textwidth]{fig3_imp.pdf}
...
\section{Results}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{fig4_map.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{fig5_example.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{fig6_fill_by_iterations.pdf}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[b]{\textwidth}
            \centering
            \caption{Local Model}\includegraphics[width=\textwidth]{fig7a_probability_pixels_NL_local.pdf}
        ...
        \begin{subfigure}[b]{\textwidth}
           ...
           \includegraphics[width=\textwidth]{fig7b_probability_pixels_NL_general.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{fig8_jointplot_F1.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{fig9_jointplot_precision.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{fig10_jointplot_recall.pdf}
    ...
    \vspace{-2cm}
        \centering
        \includegraphics[width=\linewidth]{fig11_jointplot_area_percent_error.pdf}
...
\section{Discussion}
    ...
    \subsection{Potential applications}
        ...
        \begin{figure}
            ...
            \centering
            \caption{Local Model}\includegraphics[width=\textwidth]{fig12a_f1_during_filling_local.pdf}
           ...
           \centering
           \caption{General Model}
           \includegraphics[width=\textwidth]{fig12b_f1_during_filling_general.pdf}
...
\section{IMP Algorithm in pseudocode}
\label{alg:imp}
