\chapter[EcoDataCube.eu: Analysis-Ready Open Environmental Data Cube for Europe]{EcoDataCube.eu: Analysis-Ready Open Environmental Data Cube for Europe}
\label{cha:chapter1}
\vspace*{\fill}
...
\centering
\hspace*{-2.9cm}
\includegraphics[width=1.2\textwidth]{fig_1_main_workflow.png}
...
\begin{figure}
    \includegraphics[width=\linewidth]{fig_2_study_area_satellite_input.png}
...
\begin{figure}[!hbt]
\centering
\includegraphics[width=\linewidth]{fig_3_satellite_comparison.png}
...
%f
\begin{figure}[!hbt]
    \includegraphics[width=\linewidth]{fig_4_gaps_landsat.png}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.6\linewidth]{fig_5_gapfilling_accuracy_landsat.png}
...
\begin{figure}[!hbt]
    \includegraphics[width=\linewidth]{fig_6_gaps_sentinel.png}
...
\begin{figure}[hbt]
\centering
\includegraphics[width=\linewidth]{fig_7_dtm_comparison.png}
...
\begin{figure}[!hbt]
    \includegraphics[width=\linewidth]{fig_8_dtm_accuracy.png}
...
\begin{figure}[!hbt]
    \includegraphics[width=\linewidth]{fig_9_landcover_feature_space}
...
%f
\begin{figure}[p]
\includegraphics[width=\linewidth]{fig_10_data_viewer.png}
